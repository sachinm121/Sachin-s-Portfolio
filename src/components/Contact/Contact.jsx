  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col mt-8 lg:mt-0">
        ...
        <a className="mt-10 object-fill w-fit" href="mailto:sachinmahor685@gmail.com">
          <button className="bg-yellow-600 px-5 py-3 rounded-md text-[20px] font-bold hover:bg-yellow-500">Write Sachin</button>
        </a>
      </div>
    </div>
  );
